...
public class TestTextConfiguration {
  ...
  public void copyMaze() {
    ...
    DungeonPlay dungeonPlay = new PlayTheDungeon(
            createDungeon.getLayout(), true, "*", new Random(1));
    Cave[][] mazeCopy = dungeonPlay.copyDungeon();
    dungeonPlay.moveAdventurer("up");
    assertNotEquals(dungeonPlay.toString(), MazeVisualizer.visualizer(mazeCopy));
  }
  ...
  @Test public void invalidRow() throws IOException {
    ...
    ViewForDungeon view = new TextViewForDungeon(in, out);
